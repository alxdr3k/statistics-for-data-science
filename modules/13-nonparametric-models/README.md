...
<a id="ref-13-의사결정나무"></a>[의사결정나무](#note-13-의사결정나무)는 질문을 많이 만들수록 훈련 데이터를 잘 나눌 수 있다. 하지만 너무 깊게 자라면 우연한 예외까지 규칙으로 만든다. <a id="ref-13-가지치기"></a>[가지치기](#note-13-가지치기)는 설명력을 조금 포기하더라도 새 데이터에서 덜 흔들리는 나무를 만들기 위한 장치다.
...
<a id="ref-13-차원의-저주"></a>[차원의 저주](#note-13-차원의-저주)는 <a id="ref-13-변수"></a>[변수](#note-13-변수)가 많아질수록 거리의 의미가 흐려지는 현상이다. 차원이 높으면 대부분의 점이 서로 멀게 느껴져 “가까운 이웃”을 고르는 기준이 약해질 수 있다. 그래서 <a id="ref-13-knn"></a>[KNN](#note-13-knn)은 스케일링과 차원 선택이 특히 중요하다.
