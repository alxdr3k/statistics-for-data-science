...
### 5. 원본 강의자료 보강: 트리 성장 방식과 Tie Breaking

원본 PDF는 의사결정나무 학습을 재귀적 분할로 설명한다. 한 번에 전체 규칙을 찾는 것이 아니라, 현재 노드에서 가장 잘 나누는 질문을 고르고, 나뉜 각 노드에서 같은 과정을 반복한다. 깊이 우선으로 자랄 수도 있고, 수준별로 확장할 수도 있지만 핵심은 매 단계의 분기가 전체 나무의 해석을 만든다는 점이다.
