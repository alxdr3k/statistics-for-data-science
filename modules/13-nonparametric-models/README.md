...
- **거리**: <a id="ref-13-knn"></a>[KNN](#note-13-knn)에서 가까움을 재는 기준
...
- **필수**: <a id="ref-13-의사결정나무"></a>[의사결정나무](#note-13-의사결정나무)가 질문으로 데이터를 나눈다는 점, <a id="ref-13-가지치기"></a>[가지치기](#note-13-가지치기)가 과적합을 줄이는 이유, KNN이 거리와 k에 민감하다는 점
- **심화**: 지니 <a id="ref-13-불순도"></a>[불순도](#note-13-불순도)와 엔트로피
- **나중**: 고차원에서 거리 기반 모델의 한계
...
- **<a id="ref-13-분기-기준"></a>[분기 기준](#note-13-분기-기준)**: 좋은 분기는 섞여 있던 데이터를 더 순수한 집단으로 나누는 질문이다.
...
<a id="ref-13-차원의-저주"></a>[차원의 저주](#note-13-차원의-저주)는 <a id="ref-13-변수"></a>[변수](#note-13-변수)가 많아질수록 거리의 의미가 흐려지는 현상이다. 차원이 높으면 대부분의 점이 서로 멀게 느껴져 “가까운 이웃”을 고르는 기준이 약해질 수 있다. 그래서 KNN은 스케일링과 차원 선택이 특히 중요하다.
...
- <a id="note-13-가지치기"></a>[가지치기](#ref-13-가지치기): 너무 복잡한 트리를 줄이는 과정.
- <a id="note-13-불순도"></a>[불순도](#ref-13-불순도): 한 노드 안에 클래스가 얼마나 섞여 있는지.
- <a id="note-13-분기-기준"></a>[분기 기준](#ref-13-분기-기준): 데이터를 나눌 때 섞임이나 오차를 줄이는 질문을 고르는 기준.
...
- <a id="note-13-차원의-저주"></a>[차원의 저주](#ref-13-차원의-저주): 차원이 늘수록 거리의 구분력이 약해지는 현상.
