...
<a id="ref-04-통계"></a>[통계](#note-04-통계)는 데이터를 수집, 정리, 분석, 해석하여 결론을 도출하는 학문이다. 처음에는 “평균을 계산하는 것”처럼 보일 수 있지만, 더 정확히는 데이터를 근거로 주장하는 방법이다.
...
<a id="ref-04-기술-통계"></a>[기술 통계](#note-04-기술-통계)는 비교적 직접적이다. 가진 데이터 안에서 계산한다. <a id="ref-04-추론-통계"></a>[추론 통계](#note-04-추론-통계)는 더 조심해야 한다. <a id="ref-04-표본"></a>[표본](#note-04-표본)이 <a id="ref-04-모집단"></a>[모집단](#note-04-모집단)을 잘 대표하지 못하면 계산은 정확해 보여도 결론은 틀릴 수 있다.
...
<a id="ref-04-조건부-확률"></a>[조건부 확률](#note-04-조건부-확률)은 어떤 사건이 이미 일어났다고 알고 난 뒤, 관심 범위를 그 사건 안으로 줄여 다시 계산한 확률이다.
...
<a id="ref-04-베이즈-정리"></a>[베이즈 정리](#note-04-베이즈-정리)는 조건을 거꾸로 바꿔 생각하는 방법이다.
