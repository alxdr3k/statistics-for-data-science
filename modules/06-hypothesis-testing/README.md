...
원본 강의의 가설 검정 과정은 같은 판단을 두 가지 방식으로 정리한다.
...
| 독립 두 모평균, 모분산을 아는 경우 | 두 표본평균 차이를 알려진 표준오차로 나눔 | 두 표본 독립, 모집단 정규성 |
| 독립 두 모평균, 등분산을 가정하고 모분산을 모르는 경우 | pooled variance를 사용한 t 통계량 | 자유도 `n1 + n2 - 2` |
