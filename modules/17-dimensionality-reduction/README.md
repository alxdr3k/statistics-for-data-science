...
<a id="ref-17-mds"></a>[MDS](#note-17-mds)는 거리 관계를 낮은 차원에 보존하려 하고, <a id="ref-17-t-sne"></a>[t-SNE](#note-17-t-sne)는 가까운 이웃 구조를 시각화하는 데 강하다. t-SNE는 새 데이터 변환과 재현성에 주의해야 한다.
...
<a id="ref-17-lda"></a>[LDA](#note-17-lda)는 클래스 구분이 잘 되는 축을 찾고, <a id="ref-17-pls"></a>[PLS](#note-17-pls)는 X와 y의 공분산을 잘 설명하는 성분을 찾는다. 지도 정보가 들어간다는 점이 PCA와 다르다.
