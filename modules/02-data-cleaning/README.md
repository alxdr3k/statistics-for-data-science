...
## 원본 강의자료 보강: 결측 원인과 이상치 탐지법 선택

원본 PDF의 데이터 정제 차시는 결측치와 이상치를 “지울 것인가 말 것인가”로만 보지 않는다. 결측이 완전히 무작위인지, 특정 집단이나 상황에서 더 자주 생기는지에 따라 삭제와 대치가 만드는 편향이 달라진다. 회귀 대치, Hot deck, 선형 보간은 각각 관계식, 유사 사례, 시간·순서 구조를 이용한다.
