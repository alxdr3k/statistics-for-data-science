...
- **<a id="ref-20-퍼셉트론"></a>[퍼셉트론](#note-20-퍼셉트론)**: 뉴런 하나의 계산 흐름
- **<a id="ref-20-활성화-함수"></a>[활성화 함수](#note-20-활성화-함수)**: 층을 쌓는 의미를 만드는 비선형성
...
- **필수**: <a id="ref-20-dense"></a>[Dense](#note-20-dense)와 <a id="ref-20-embedding"></a>[Embedding](#note-20-embedding)의 역할, <a id="ref-20-cnn"></a>[CNN](#note-20-cnn)이 지역 패턴을 보는 이유, <a id="ref-20-rnn"></a>[RNN](#note-20-rnn)/<a id="ref-20-lstm"></a>[LSTM](#note-20-lstm)/<a id="ref-20-gru"></a>[GRU](#note-20-gru)가 순서를 다루는 이유
- **심화**: <a id="ref-20-dropout"></a>[Dropout](#note-20-dropout)과 BatchNorm의 훈련/추론 차이
...
- **보조 레이어**: Dropout, BatchNorm, <a id="ref-20-pooling"></a>[Pooling](#note-20-pooling) 같은 레이어는 학습 안정성, 일반화, 정보 압축을 돕는다.
...
2. <a id="ref-20-dense-layer"></a>[Dense Layer](#note-20-dense-layer)는 모든 입력과 출력을 연결하므로 파라미터 수를 계산할 수 있어야 한다.
...
- <a id="note-20-퍼셉트론"></a>[퍼셉트론](#ref-20-퍼셉트론): 입력에 가중치를 곱해 판단하는 기본 신경망 단위. ([처음 설명된 차시](../19-perceptron/README.md#1-단층-퍼셉트론))
- <a id="note-20-활성화-함수"></a>[활성화 함수](#ref-20-활성화-함수): 출력 신호를 비선형으로 바꾸는 함수. ([처음 설명된 차시](../19-perceptron/README.md#3-활성화-함수))
...
- <a id="note-20-dense-layer"></a>[Dense Layer](#ref-20-dense-layer): 모든 입력과 뉴런이 연결된 기본 층.
