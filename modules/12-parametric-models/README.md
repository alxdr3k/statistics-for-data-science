...
### 5. 원본 강의자료 보강: 규제와 나이브 베이즈 종류

원본 PDF는 규제가 적용된 선형회귀를 Ridge와 Lasso 관점으로 다룬다. Ridge는 L2 벌점으로 계수를 전반적으로 줄여 다중공선성이 있는 상황에서도 안정적인 해를 만들기 쉽다. Lasso는 L1 벌점으로 일부 계수를 0으로 만들어 변수 선택 효과를 준다. Elastic Net은 두 벌점을 섞어, 강하게 관련된 변수들이 많은 상황에서 한쪽 성질만 쓰는 약점을 줄인다.
