...
- **<a id="ref-03-변수"></a>[변수](#note-03-변수) 타입**: <a id="ref-03-인코딩"></a>[인코딩](#note-03-인코딩)과 스케일링을 고르는 기준
- **<a id="ref-03-이상치"></a>[이상치](#note-03-이상치)**: 변환이 튀는 값의 영향을 줄일 수 있다
...
- **필수**: <a id="ref-03-정규화"></a>[정규화](#note-03-정규화)와 <a id="ref-03-표준화"></a>[표준화](#note-03-표준화) 구분, 인코딩의 목적, <a id="ref-03-로그-변환"></a>[로그 변환](#note-03-로그-변환)이 오른쪽 꼬리를 줄이는 이유
- **심화**: Box-Cox, Yeo-Johnson 같은 거듭제곱 변환
- **나중**: <a id="ref-03-파생-변수"></a>[파생 변수](#note-03-파생-변수)를 모델 성능과 해석에 연결
...
- **<a id="ref-03-분포-변환"></a>[분포 변환](#note-03-분포-변환)**: 소득처럼 일부 큰 값이 긴 꼬리를 만들면 평균과 모델이 큰 값에 끌려간다.
- **<a id="ref-03-구간화"></a>[구간화](#note-03-구간화)**: 나이 37세와 38세의 차이보다 “30대 후반”이라는 구간이 더 해석에 유용할 때가 있다.
