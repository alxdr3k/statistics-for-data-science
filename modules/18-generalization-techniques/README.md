...
<a id="ref-18-그리드-서치"></a>[그리드 서치](#note-18-그리드-서치)는 후보 조합을 모두 본다. <a id="ref-18-랜덤-서치"></a>[랜덤 서치](#note-18-랜덤-서치)는 넓은 공간을 빠르게 탐색한다. 탐색은 검증 데이터나 <a id="ref-18-교차검증"></a>[교차검증](#note-18-교차검증)으로 평가해야 한다.
...
오버샘플링은 소수 클래스를 늘리고 언더샘플링은 다수 클래스를 줄인다. <a id="ref-18-smote"></a>[SMOTE](#note-18-smote)와 <a id="ref-18-adasyn"></a>[ADASYN](#note-18-adasyn)은 합성 <a id="ref-18-표본"></a>[표본](#note-18-표본)을 만든다. 샘플링은 훈련 데이터 안에서만 해야 누수를 막을 수 있다.
