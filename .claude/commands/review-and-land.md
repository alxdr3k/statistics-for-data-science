...
2. required checks가 모두 SUCCESS인가? 미완료/실패 항목이 있으면 `gh -R "$REVIEW_LOOP_PASS_REPO" pr checks "$REVIEW_LOOP_PASS_PR_NUMBER" --watch`로 완료를 기다린다.
