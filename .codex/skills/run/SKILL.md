...
<!-- my-skill:generated
skill: run
base-sha256: 264dae348a539279d602ea0c6d2853937aa21988619d8dd182f2003a3ea2a4d5
overlay-sha256: e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
output-sha256: 264dae348a539279d602ea0c6d2853937aa21988619d8dd182f2003a3ea2a4d5
...
- 모든 repo는 같은 입력 규칙을 쓴다. `$REVIEW_BASE...HEAD`만 보지 않고, commit 전 local diff와 untracked files가 있으면 반드시 Review Pass 입력에 포함한다.
...
- 의도한 파일만 stage, commit, `RUN_WORK_BRANCH` push. 이어서 PR body를 `PR_BODY_FILE` 경로의 파일로 작성하고 (아래 'Test plan 섹션' 참고) `check-test-plan`을 통과한 뒤 GitHub app 또는 `gh pr create`로 **draft가 아닌 open PR**을 생성한다. 생성 결과 URL에서 PR 번호를 추출해 `PR_NUMBER`에 저장하고 Step 9에서 같은 변수를 사용한다.
