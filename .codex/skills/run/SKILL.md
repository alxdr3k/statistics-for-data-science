...
<!-- my-skill:generated
skill: run
base-sha256: decb0728656bc03d1a0d038d394c8d02a45bd926f4a265616ba1b8453c83abb5
overlay-sha256: e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
output-sha256: decb0728656bc03d1a0d038d394c8d02a45bd926f4a265616ba1b8453c83abb5
...
Codex 리뷰어는 항상 `--model gpt-5.5`를 명시적으로 전달한다. 사용자별
`~/.codex/config.toml` default model이 달라도 run Step 6 리뷰는 동일한 reviewer 모델로
고정되어, cycle 간 finding 품질이 model 선택에 의해 흔들리지 않도록 한다.
...
- 검증을 통과하면 `codex-loop` 스킬을 같은 세션에서 PR 번호와 함께 실행한다 (예: `codex-loop "$PR_NUMBER"`).
...
- `codex-loop`은 review feedback 처리, checks 확인, merge까지 완료해야 한다. 해당 PR이 merge되기 전에는 cycle을 마치거나 다음 loop로 넘어가지 않는다.
